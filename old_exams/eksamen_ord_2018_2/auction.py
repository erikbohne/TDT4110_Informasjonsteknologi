...
#fits the examples given in the assignments.
    return[[ 'Customer','vase','maleri','sykkel','bilbane','tv'],['Per',100  ,0,200   ,0,1500],['Ida',110  ,50 ,200   ,0,1500],['Ottar',200   ,600,200  ,0,1700],['Dag',200   ,600  ,200   ,0,1700],['Lise',400  ,600  ,0,0,0]]
